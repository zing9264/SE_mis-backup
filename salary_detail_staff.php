...
include_once ('lib/Salary.php');
    ...
    if(isset($_GET['salary_id'])){
        ...
        if($salary_date['state']==0 || ($salary_date['staff_id']!=$_SESSION[md5('id')] && $Staff->check_permission('accountant'))){
            header("Location:index.php?tab=salary_list");
            exit;
        }
    }
    else{
...
<html>
    ...
    <!--<button type="button" class="btn btn-secondary">核可</button>-->
